          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <HoverCard openDelay={200} closeDelay={200}>
                <HoverCardTrigger>
                  <button className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground h-9 w-9 outline-none focus-visible:ring-2 focus-visible:ring-ring">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => toggleEditMode("name")}>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => toggleEditMode("discord")}>
                          <Pencil className="h-3 w-3" />
                        </Button>
                      </div>
                      {editMode.discord ? (
                        <Input
                          ...
                          onChange={(e) => setUserProfile({ ...userProfile, discord: e.target.value })}
                          onBlur={() => toggleEditMode("discord")}
                          autoFocus
                          className="h-8"
                        />
                      ) : (
                        <p className="text-sm text-muted-foreground">{userProfile.discord}</p>
                      )}
                    </div>
